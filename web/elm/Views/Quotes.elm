...
quotes model =
    div [ class "center mw6 mt4" ]
        ...
        , div [ class "relative pa5" ]
            [ h2 [ class "black relative z-3 handwriting f2" ] [ text <| getQuote model ]
            , img [ class "absolute top-0 left-0 z-1 h-100 w-100", src "/images/speech-bubble-1.png" ] []
            ]
        , button [ class (Styles.buttonClear ++ " ma3 relative z-3"), onClick <| SubmitAnswer Yes ] [ text "Yes, I feel like this" ]
